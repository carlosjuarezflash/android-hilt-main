...
import com.example.logviewer.di.DaggerLogViewerComponent
...
class LogsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        DaggerLogViewerComponent.builder()
            .context(requireContext())
            .appDependencies(
                EntryPointAccessors.fromApplication(
                    requireActivity().applicationContext,
                    LogViewerDependencies::class.java
                )
            )
            .build()
            .inject(this)
...
private class LogsViewAdapter(
    private val logsDataSet: List<com.example.baseapp.data.Log>,
    private val daterFormatter: com.example.baseapp.util.DateFormatter
